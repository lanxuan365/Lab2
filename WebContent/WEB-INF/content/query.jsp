...
<html>
  <head>
    ...
    <link href="home/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <div id="base" class="">
      ...
      <form action="query" method= "post">
          ...
          <div id="u0" class="ax_text_field">
     		<input id="u0_input" type="text" name="name" value=""/>
   		  </div>
      		
	      <div id="u3" class="ax_html_button">
	        <input id="u3_input" type="submit" value="查询"/>
	      </div>
